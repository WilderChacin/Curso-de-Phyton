...
print(f"Bienvenido {nombre_persona} es todo un placer")

print("Mi comida favorita es el pollo frito")

resultado_resta = 15 - 5
print(f"El resultado de la resta es: {resultado_resta}")

edad = input("¿Cuántos años tienes? ")
print(f"Tienes {edad} años")

print("El nombre de mi mascota es Lobo")

multiplicacion = 3 * 4
print(f"El resultado de 3 por 4 es: {multiplicacion}")
